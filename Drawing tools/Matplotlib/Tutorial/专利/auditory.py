...
plt.plot(gains_auditory,estimation_auditory_withtask, color='royalblue', linestyle='solid', linewidth=2, marker='o', markersize=4, label="高认知负载")
plt.plot(gains_auditory,estimation_auditory_withouttask, color='darkorange', linestyle='dashed', linewidth=2, marker='o', markersize=4, label="低认知负载")
plt.plot(gains_auditory,estimation_auditory_mean, color='grey', linestyle='-', linewidth=2, alpha=0.5, marker='o', markersize=4, label="均值")
plt.xlabel(r'听觉授时因子 ($g_a$)')
